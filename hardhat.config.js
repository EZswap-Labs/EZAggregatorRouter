...
const arbtestUrl = process.env.arbtestUrl
const arbtestAccount = process.env.arbtestAccount

const arbUrl = process.env.arbUrl
const arbAccount = process.env.arbAccount
...
const arbscanApiKey = process.env.arbscanApiKey
